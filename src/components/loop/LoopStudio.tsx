              ...
              <CardContent className="space-y-2 text-xs">
                ...
                <div className="flex gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-white/50">цикл пишет только в файлы памяти проекта — никаких писем, платежей и продакшена</div>
                  </div>
                </div>
                <div className="flex gap-2">
                  <span className="text-green-400">✓</span>
